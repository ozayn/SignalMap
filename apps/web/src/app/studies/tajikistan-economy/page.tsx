...
export const metadata: Metadata = buildStudyMetadata("tajikistan-economy");

export default function TajikistanEconomyStudyPage() {
  const cfg = getCountryEconomyConfig("tajikistan-economy");
