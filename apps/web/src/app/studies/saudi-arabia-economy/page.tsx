...
export const metadata: Metadata = buildStudyMetadata("saudi-arabia-economy");

export default function SaudiArabiaEconomyStudyPage() {
  const cfg = getCountryEconomyConfig("saudi-arabia-economy");
