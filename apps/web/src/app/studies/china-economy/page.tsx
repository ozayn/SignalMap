...
export const metadata: Metadata = buildStudyMetadata("china-economy");

export default function ChinaEconomyStudyPage() {
  const cfg = getCountryEconomyConfig("china-economy");
