...
export const metadata: Metadata = buildStudyMetadata("russia-economy");

export default function RussiaEconomyStudyPage() {
  const cfg = getCountryEconomyConfig("russia-economy");
