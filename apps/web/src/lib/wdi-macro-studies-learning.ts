...
const GDP_GLOBAL_COMPARISON_EN: LearningNoteSection[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "The WLD aggregate follows World Bank methodology; it is not the sum of only the displayed countries on the chart.",
    ],
  },
];
...
const GDP_GLOBAL_COMPARISON_FA: LearningNoteSection[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "مجموع WLD طبق روش بانک جهانی است؛ جمع صرفاً کشورهایی که روی نمودار نمایش داده شده‌اند نیست.",
    ],
  },
];
...
const ISI_DIAGNOSTICS_FA: LearningNoteSection[] = [
  {
    ...
    bullets: [
      ...
      "این صفحه شاخص رسمی «رژیم ISI» برآورد نمی‌کند؛ فقط سهم‌های استاندارد WDI بازرگانی و صنعت به‌همراه رشد واقعی تولید ناخالص داخلی را می‌گذارد تا الگوهای تاریخی را ببینید.",
  ...
  },
  {
    heading: "چگونه بخوانید",
    bullets: [
      "ساختار تجارت: برای هر کشور دو خط — واردات و صادرات به‌صورت درصدی از تولید ناخالص داخلی (یک مقیاس عمودی).",
      "ساختار صنعتی: ارزش افزوده تولید صنعتی و ارزش افزوده بخش صنعت هر دو درصدی از تولید ناخالص داخلی هستند (تولید صنعتی بخشی از صنعت در حساب‌های ملی است).",
      "پیامدها: رشد سالانهٔ واقعی تولید ناخالص داخلی (NY.GDP.MKTP.KD.ZG) به‌صورت درصد در سال — شاخص‌نشده.",
...
const DUTCH_DIAGNOSTICS_FA: LearningNoteSection[] = [
  {
    ...
    bullets: [
      ...
      "پایین: چهار نمودار جدا — (۱) رانت نفتی درصدی از تولید ناخالص داخلی، (۲) ارزش افزوده تولید صنعتی درصدی از تولید ناخالص داخلی، (۳) واردات درصدی از تولید ناخالص داخلی، (۴) دلار به تومان بازار آزاد.",
