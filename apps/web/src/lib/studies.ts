...
export const STUDIES: StudyMeta[] = [
  ...
  },
  {
    ...
    subtitle: "United States, China, Iran, Turkey, Saudi Arabia, Russia, and world total (World Bank WDI)",
    timeRange: ["1960-01-01", new Date().toISOString().slice(0, 10)],
    description: "Total GDP (WDI): levels or index to 2000=100. US, China, IR, TR, SA, RU + world—relative growth, not a ranking of size in index view.",
    status: "active",
    countries: ["iran", "us", "global"],
    themes: ["macro"],
    tags: ["GDP", "Index", "WDI"],
    keywords: ["ny.gdp.mktp.kd", "ny.gdp.mktp.cd", "aggregate", "china", "turkey", "saudi arabia", "russia", "world"],
    ...
    observations: [
      ...
      "The world aggregate (WLD) is a World Bank series; it is not a simple sum of only the displayed countries.",
  ...
  },
  {
    ...
    countries: ["iran"],
    themes: ["macro", "fx", "oil"],
    tags: ["Iran", "WDI", "history", "presidency", "Pahlavi", "focus", "comparison", "FX", "inflation"],
    keywords: [
      "1960",
      "1979",
      "Pahlavi",
    ...
    observations: [
      ...
      "Minimum-wage / real-wage series may start later than the outer window; the wage panel only plots overlapping years returned by the wage API.",
